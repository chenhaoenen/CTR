...
def parse_arguments():
    ...
    parser.add_argument('--deep_layers', nargs='+', type=int, default=[1024, 512, 256, 32, 8],  help='The layer hiddens for mlp.')
...
def prepare_model(args):
    ...
    model = XDeepFM(sparse_feat_and_nums=sparse_feat_and_nums,
                   dense_feat=dense_feat,
                   embed_dim=args.embedding_dim,
                   deep_layers=args.deep_layers,
                   cin_layers=[128, 128, 64, 32, 16],
                   sigmoid_out=True)
