...
from src.model.deepcrossing import DeepCrossing
...
def parse_arguments():
    ...
    parser.add_argument('--res_layers', nargs='+', type=int, default=[1024, 512, 512, 1024],  help='The layer hiddens for res.')
...
def prepare_model(args):
    ...
    model = DeepCrossing(sparse_feat_and_nums=sparse_feat_and_nums,
